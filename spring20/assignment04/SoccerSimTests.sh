...
echo ... Testing PlaygroundSoccerSim out of bounds...
echo ...   Should throw exception that will not show in results
echo ...   Or should output a message of some type
echo .                                       						>> testresults.txt
echo .                                       						>> testresults.txt
echo ======================================  						>> testresults.txt
echo ... Testing PlaygroundSoccerSim out of bounds...  				>> testresults.txt
echo ...   Should throw exception that will not show in results 	>> testresults.txt
echo ...   Or should output a message of some type 					>> testresults.txt
echo ======================================  						>> testresults.txt
java PlaygroundSoccerSim 2 2 99 99                   				>> testresults.txt

echo ... Testing PlaygroundSoccerSim negative time slice...
echo ...   Should throw exception that will not show in results
echo ...   Or should output a message of some type
echo .                                       						>> testresults.txt
echo .                                       						>> testresults.txt
echo ======================================  						>> testresults.txt
echo ... Testing PlaygroundSoccerSim negative time slice...			>> testresults.txt
echo ...   Should throw exception that will not show in results 	>> testresults.txt
echo ...   Or should output a message of some type 					>> testresults.txt
echo ======================================  						>> testresults.txt
...
echo .                                       						>> testresults.txt
echo ======================================  						>> testresults.txt
echo ... Testing PlaygroundSoccerSim ball should come to rest...	>> testresults.txt
...
echo .                                       						>> testresults.txt
echo ======================================  						>> testresults.txt
echo ... Testing PlaygroundSoccerSim ball should go out of bounds...>> testresults.txt
