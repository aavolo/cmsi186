public class Dog {
	...
	public String toString () {
		return this.name + " is a " + this.color + " " + this.breed + " who is " +this.age + " years old and weighs " +this.weight + " pounds.";
	}
	...
	public static void main(String[] args){
		Dog d1 = new Dog("Tinker", 1, "female", 12.2, "dachshund", "choloate & tan");
